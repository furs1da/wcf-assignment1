# Dmytrii Furs (#8703133) Assignment #1 (wcf-assignment1)

2 projects included (WCF Service Application "Assignment1Service and Console Application (.NET Framework) "AssignmentClient".
